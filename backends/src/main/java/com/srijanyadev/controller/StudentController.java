...
import com.srijanyadev.service.StudentService;
...
public class StudentController {
    ...
    public ResponseEntity<ApiResponse<List<StudentDTO>>> getAllStudents() {
        try {
            ...
            return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR)
                    .body(ApiResponse.error("Failed to retrieve students", List.of(e.getMessage())));
        }
    }
    ...
    public ResponseEntity<ApiResponse<List<StudentDTO>>> getActiveStudents() {
        try {
            ...
            return ResponseEntity.ok(
                    ApiResponse.success("Active students retrieved successfully", students)
            );
        } catch (Exception e) {
            return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR)
                    .body(ApiResponse.error("Failed to retrieve active students", List.of(e.getMessage())));
        }
    }
    ...
    public ResponseEntity<ApiResponse<StudentDTO>> getStudentById(@PathVariable Long id) {
        try {
            ...
            if (student.isPresent()) {
                return ResponseEntity.ok(
                        ApiResponse.success("Student retrieved successfully", student.get())
                );
            } else {
                return ResponseEntity.status(HttpStatus.NOT_FOUND)
                        .body(ApiResponse.error("Student not found", List.of("No student found with ID: " + id)));
            }
        } catch (Exception e) {
            return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR)
                    .body(ApiResponse.error("Failed to retrieve student", List.of(e.getMessage())));
        }
    }
    ...
    public ResponseEntity<ApiResponse<StudentDTO>> getStudentByEmail(@PathVariable String email) {
        try {
            ...
            if (student.isPresent()) {
                ...
                return ResponseEntity.status(HttpStatus.NOT_FOUND)
                        .body(ApiResponse.error("Student not found", List.of("No student found with email: " + email)));
            }
        } catch (Exception e) {
            return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR)
                    .body(ApiResponse.error("Failed to retrieve student", List.of(e.getMessage())));
    ...
    public ResponseEntity<ApiResponse<StudentDTO>> getStudentByRollNo(@PathVariable String rollNo) {
        try {
            ...
            if (student.isPresent()) {
                ...
                return ResponseEntity.status(HttpStatus.NOT_FOUND)
                        .body(ApiResponse.error("Student not found", List.of("No student found with roll number: " + rollNo)));
            }
        } catch (Exception e) {
            return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR)
                    .body(ApiResponse.error("Failed to retrieve student", List.of(e.getMessage())));
    ...
    public ResponseEntity<ApiResponse<StudentDTO>> createStudent(@RequestBody StudentDTO studentDTO) {
        try {
            ...
            return ResponseEntity.status(HttpStatus.BAD_REQUEST)
                    .body(ApiResponse.error("Failed to create student", List.of(e.getMessage())));
        }
    }
    ...
    public ResponseEntity<ApiResponse<StudentDTO>> updateStudent(@PathVariable Long id, @RequestBody StudentDTO studentDTO) {
        try {
            ...
            return ResponseEntity.status(HttpStatus.BAD_REQUEST)
                    .body(ApiResponse.error("Failed to update student", List.of(e.getMessage())));
        }
    }
    ...
    public ResponseEntity<ApiResponse<Void>> deleteStudent(@PathVariable Long id) {
        try {
            ...
            return ResponseEntity.status(HttpStatus.BAD_REQUEST)
                    .body(ApiResponse.error("Failed to delete student", List.of(e.getMessage())));
        }
    }
}
